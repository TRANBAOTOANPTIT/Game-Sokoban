...
/**
 * Main is the main point of this project which will 
...
public class Main {
    ...
    /**
     * the starting point of program that initalizes Sokoban instance and menusrceen  
    ...
    public static void main(String args[]) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
        ...
        myMenuScreen.showMenuScreen(Main);
    }
}